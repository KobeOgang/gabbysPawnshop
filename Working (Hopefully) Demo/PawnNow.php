...
<body>
    ...
    <div class="categories">
        <div class="container-categories">
            <div class="products">
                <div class="col-4">
                    <a href="PawnNow Scripts/JPawn.php"><img src="images/service-icon-4.png" alt=""></a>
                    <br>
                    <h4>Jewelry</h4>
                </div>
                <div class="col-4">
                    <a href="PawnNow Scripts/Tablet_Pawn.php"><img src="images/Tablet.png" alt=""></a>
                    <br>
                    <h4>Tablet</h4>
                </div>
                <div class="col-4">
                    <a href="PawnNow Scripts/watch_Pawn.php"><img src="images/service-icon-2.png" alt=""></a>
                    <br>
                    <h4>Watch</h4>
                </div>
                <div class="col-4">
                    <a href="PawnNow Scripts/phone_Pawn.php"><img src="images/service-icon-1.png" alt=""></a>
                    <br>
                    <h4>Smartphone</h4>
                </div>
            </div>
